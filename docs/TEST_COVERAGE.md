...
| **Frontend** (`vitest`) | 15 | **157** | `pnpm test:coverage` enabled (v8); UI primitives + pages now unit-tested |
| **E2E** (`playwright`) | 2 | **29** | 26 integration smoke + **3 visual regression** baselines |
| **Total** | 27 | **364** | Gap-closure plan implemented (see [Post-implementation](#post-implementation-2026-05-27)) |
